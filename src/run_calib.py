#------- Script to run the esorex MATISSE Data Reduction Pipelin (DPL) ----------
...
parser.add_argument('-c','--config_file',dest='config_file', metavar='CONFIG_FILEPATH', type=str, default=config_loc, help='Enter the filepath containing your esorex.rc file.')
...
if do_mcd:
	...
	call('esorex --config=\"{}\" mat_cal_det --gain={} --nditskip={} --cosmics={} --darklimit={} --flatlimit={} --min_linear_range={} --max_linear_range={} --max_nonlinear_range={} --max_rel_deviation={} --max_abs_deviation={} --compensate={} --nlstart={} --nlstep={} --poi={} --expert={} --nt={} {}'\
		.format(args.config_file, gain, nditskip, cosmics, darklimit, flatlimit, min_linear_range, max_linear_range, max_nonlinear_range, max_rel_deviation, max_abs_deviation, compensate, nlstart, nlstep, poi, expert, nt, mcd_sof), shell=True)
...
if do_mre_targ:
	...
	call('esorex --config=\"{}\" mat_raw_estimates --gain={} --reduce_flag={} --ioi={} --useAvgSky={} --useKappaMatrix={} --replaceTel={} --useOpdMod={} --coherentIntegTime={} --ChromaticOpdFit={} --corrFlux={} --catalog={} --diamStar={} --diamErr={} --cumulBlock={} {}'\
		.format(args.config_file, gain, reduce_flag, ioi, useAvgSky, useKappaMatrix, replaceTel, useOpdMod, coherentIntegTime, ChromaticOpdFit, corrFlux, catalog, diamStar, diamErr, cumulBlock, mre_targ_sof), shell=True)
